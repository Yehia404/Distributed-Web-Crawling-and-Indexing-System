...
IMAGE="$ACCOUNT.dkr.ecr.$REGION.amazonaws.com/crawler-worker:latest"
...
sudo docker run -d --name crawler --env-file /home/ec2-user/env.list --restart unless-stopped "$IMAGE"